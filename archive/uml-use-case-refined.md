# Refined SCRM AI Platform Use Case Diagram

This document contains the refined, presentation-ready UML Use Case diagram for the Supply Chain Risk Management (SCRM) AI Platform. It has been styled with a custom, high-fidelity color scheme and organized into clear functional phases to maximize clarity for slides and presentations.

## Rendered Use Case Diagram

![SCRM Use Case Diagram](uml-use-case-refined.png)
...
flowchart LR
    ...
    subgraph SCRM ["🛡️ Supply Chain Risk Management (SCRM) AI Platform"]
        ...
        subgraph Phase3 ["Phase 3: Execution & Closed Loop"]
            direction TB
    ...
    subgraph ExternalSystems ["⚙️ External Systems"]
        ...
        ERPSystem("⚙️ Enterprise ERP / MRP"):::external
        Supplier("🏭 Target Supplier"):::external
    end
    ...
    subgraph AIAgents ["🤖 Specialized AI Agents & DBs"]
        ...
        HistDB("🗄️ Historical Precedent DB"):::external
    end
    ...
    UC_InboundResp -. "<<extend>> <br>(Recalculates Risk)" .-> UC_Triage
    ...
    classDef phase3 fill:#EFF6FF,stroke:#3B82F6,stroke-width:2px,color:#1E3A8A,font-weight:bold;
    ...
    style Phase3 fill:#F5FAFF,stroke:#BFDBFE,stroke-width:1px;
